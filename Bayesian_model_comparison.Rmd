...
This plots the regression line that was computed from the Bayesian ANOVA model. The uncertainty is visualised via draws from the posterior distribution at each heading angle. 
