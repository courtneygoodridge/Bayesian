...
To further investigate the main effects, I implement a restriction model. Specifically for dose, I am likely to have some a priori expectations of the direction of the effect i.e. higher doses of vitamins lead to increased tooth growth. First I update the dose main effect model with the correct contrast settings to alleviate biased priors.

The restriction model reveals that the data are 6 times more likely under the restriction models vs the un-restricted model. This is over 3 and thus acts as substantial evidence versus the unrestricted model. 
