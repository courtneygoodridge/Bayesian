...
According toR documentation (https://www.rdocumentation.org/packages/rstanarm/versions/2.19.2/topics/stan_aov) specifying the the family as a gamma dsitribution with identity link function estimates a linear model but with different priors i.e. priors with a gamma distribution. Hence my model still classifies as a linear model. 
