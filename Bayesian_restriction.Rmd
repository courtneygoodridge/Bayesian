...
First I fit a Bayesian model under the default contrast setting (*contr.sum*).
...
# compute prior model under the default sum treatments and estimated marginal means of this prior model
