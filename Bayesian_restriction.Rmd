...
I pass my prior estimates model for my priors arguement (as it is calculated from draws of the prior distribution) and the orignal model as my posterior argument. Hence with both prior and posteriors set, I can compute a Bayes factor (the degree of change from prior to posterior odds) based on my hypothesis.
