...
"*95% of the the most credible values for standardised effect size of my contrasts are not practically equivalent to the null*". 
...
It does not detail the magnitude or importance of an effect - rather that an effect is positive and negative and waht the probability of that is. 
