...
ggplot(data = priors, mapping = aes(x = heading, col = prior)) +
         geom_density(alpha = 0.3) +
  scale_colour_manual(name = "Prior", labels = c("Cauchy, scale = 0.2", "Cauchy, scale = 1", "Normal, scale = 2.5"), values = c("yellow", "red", "blue")) +
  ggtitle("Prior distributions for heading") +
  xlim(-10, 10) +
  theme_plot +
  theme(legend.position = c(0.8, 0.5))
...
ggplot(data = posteriors, aes(x = heading, col = prior)) +
  geom_density(alpha = 0.3) +
  scale_colour_manual(name = "Prior", labels = c("Cauchy, scale = 0.2", "Normal, scale = 2.5", "Cauchy, scale = 1"), values = c("yellow", "red", "blue")) +
  xlim(-.20, .20) +
  theme_plot
