...
Here we visualise the posterior distribution from our model. The vertical lines indicate the mean, median and Maximum A Posteriori (peak of the posterior) values from the posterior distribution. These represent the most likely values of the true effect size parameter. 
