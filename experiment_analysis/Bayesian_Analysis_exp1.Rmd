...
After this, I compute a Bayes factor against the ROPE value I used to investigate my posterior distribution. The Bayes factor is still very large, suggesting my effect is substantial. Bayes factors are larger for the model with a prior specified as a narrow cauchy distribution, followed by a wide cauchy distribution, and then a normal distribution. 
